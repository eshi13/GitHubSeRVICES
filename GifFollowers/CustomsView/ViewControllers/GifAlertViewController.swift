...
class GifAlertViewController: UIViewController {
    
    let containerView = UIView()
    let titleLabel = GifTitleLabel(fontSize: 20, textAlignment: .center)
    let bodyLabel = GifBodyLabel(textAlignment: .center)
    let actionButton = GifButton(backgroudColour: .systemPink, title: "OK")
